...
- **16 skills + 7 subagents** mirror the workflow. Both Claude Code and OpenCode discover skills natively from the `skills/` directory; no separate slash-command shims are needed.
...
├── skills/                       # 16 SKILL.md files (SOT for workflows)
